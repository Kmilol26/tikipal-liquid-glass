...
export function BookingWidget() {
    ...
    return (
        <div className="sticky top-28 group/widget transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)]">
            ...
            <AnimatePresence>
                {showConfirmation && (
                    <div className="fixed inset-0 z-[100] flex items-start justify-center p-6 pt-[12vh] md:pt-[15vh]">
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-[540px] bg-white/90 backdrop-blur-3xl border border-white rounded-[40px] p-10 shadow-2xl overflow-hidden"
                        >
                            {/* Inner Glow */}
                            ...
                            <div className="relative z-10 text-center">
                                {/* Decorative Icon */}
                                <div className="mx-auto w-20 h-20 rounded-3xl bg-tikipal-orange/10 flex items-center justify-center mb-8 border border-tikipal-orange/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)]">
                                    <ShieldCheck className="text-tikipal-orange" size={40} strokeWidth={1.5} />
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button
                                        onClick={() => setShowConfirmation(false)}
                                        className="h-14 rounded-2xl border border-tikipal-orange/30 text-tikipal-orange font-bold text-[14px] hover:bg-tikipal-orange/5 transition-colors"
                                    >
                                        Cancelar
                                    </button>
                                    <button

...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-[#FFF5F1] via-[#FFF8F5] to-white flex items-center justify-center p-4">
            <div className="w-full max-w-[420px] bg-white rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 md:p-10 relative overflow-hidden">
                {/* Decorative background blur inside card */}
                <div className="absolute top-0 left-0 w-40 h-40 bg-orange-50/50 rounded-full blur-3xl -ml-20 -mt-20 pointer-events-none" />
                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <p className="text-gray-500 font-medium text-sm text-center mb-8">
                        Únete a Tikipal y gestiona tus eventos
                    </p>
                    ...
                    <form className="w-full space-y-4" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <button className="w-full py-4 bg-tikipal-orange hover:bg-orange-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-tikipal-orange/20 hover:shadow-xl hover:shadow-tikipal-orange/30 transform hover:-translate-y-0.5 transition-all duration-300 mt-4">
                            Registrarse
                        </button>

                        <div className="relative flex items-center gap-4 my-2">
                            <div className="h-px bg-gray-100 flex-1" />
                            <span className="text-xs font-medium text-gray-400">O regístrate con</span>
                            <div className="h-px bg-gray-100 flex-1" />
                        </div>

                        <button className="w-full py-3.5 bg-white border border-gray-100 hover:bg-gray-50 text-gray-700 rounded-xl text-sm font-bold flex items-center justify-center gap-3 transition-all duration-300 group">
            ...
            <div className="absolute bottom-8 left-0 right-0 text-center">
                <p className="text-sm font-medium text-gray-500">
                    ...
                    <Link href="/login" className="font-bold text-tikipal-orange hover:text-orange-600 transition-colors">
                        Iniciar sesión
                    </Link>
                </p>
            </div>
